...
/* ── Logo mark (shared visual with Login) ────────────────────────────────── */
const LogoMark = () => (
  <Link
    to="/"
      ...
      <div className="relative w-full max-w-[400px] z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
            Start managing projects with DevTask.
          </p>
        </div>
        ...
        <p className="text-center mt-6 text-sm" style={{ color: 'var(--text-muted)' }}>
          ...
          <Link to="/login" className="font-semibold transition-colors" style={{ color: 'var(--accent-text)' }}>
            Sign In
          </Link>
        </p>
      </div>
